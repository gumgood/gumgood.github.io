...
![](../assets/postimg/2021-06-05-sort-by-angular/sort-by-angular-1.png)
...
![](../assets/postimg/2021-06-05-sort-by-angular/sort-by-angular-2.png)
...
![](../assets/postimg/2021-06-05-sort-by-angular/sort-by-angular-3.png)

두 영역에 대해서는 임의로 순서를 정해주면 비교 연산이 성립하게 됩니다.

![](../assets/postimg/2021-06-05-sort-by-angular/sort-by-angular-4.png)

## 구현

비교 연산에 필요한 외적은 $O(1)$에 구할 수 있으므로 $O(n \log n)$에 구현할 수 있습니다. 각도가 같은 경우 원점에 가까운 순서로 정렬했는데, 필요에 따라 변형해서 사용하면 됩니다.
